...
export class UniStackLanguageServer {
  ...
  private builtins = ['DataSet', 'Response', 'Request', 'json', 'error', 'http.get', 'UI.render', 'FS.readFile'];
...
` };
    ...
    const hovers: { [key: string]: string } = {
      ...
      'http.get': 'Standard library HTTP GET helper',
      'UI.render': 'Standard library UI rendering helper',
      'FS.readFile': 'Standard library filesystem read helper',
    };
