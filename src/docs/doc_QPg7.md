...
- Full LSP server with ANTLR metadata and VS Code support
- UniStd standard library (network, graphics, filesystem)
- UniPack package manager with precompiled modules
- Beauty injector (ui-engine) for automatic design system
