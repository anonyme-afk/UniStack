...
## [1.0.0] - Production release / 2026

**english:**

### Added
- Full Phase F polish including
  - build-time SQL injection detection for string concatenation
  - default production rate‑limiting (1000/15min) when no middleware section
  - automatic helmet headers and secret‑redacting logs in production
  - comprehensive documentation and cookbook
  - three complete example `.uni` applications (todo, blog with auth, chat)
  - GitHub Actions CI with multi‑node versions, audit check and publish workflow
  - issue templates (bug report & feature request)
  - environment variable validation and defaults
  - extensive quick reference and language guide
...
### Documentation
- overhauled README with 30‑second pitch
- added complete developer / contributing guide updates

---

## [0.1.0] - legacy prototype Release / 2024
...
- 16 core test cases validating the entire toolchain (parser, transpiler, LSP, packages, etc.)
- Project licensed under Apache 2.0; added license headers to source files
- Added build infrastructure: Makefile, Dockerfile, .env.example, pre-commit hook
- Added CI workflow (.github/workflows/ci.yml)
- Added security policy, OpenAPI stub, architecture diagrams, benchmark script
...
- 16 cas de test principaux validant l'ensemble de la chaîne d'outils (parser, transpileur, LSP, paquets, etc.)
...
- Les requêtes SQL retournent un tableau vide placeholder (stub pour Advanced line)
