...
**english:** UniStack is a unified full-stack programming language that allows developers to write entire applications in a single `.uni` file. Instead of switching between Python for backend, JavaScript for frontend, and HTML/CSS for UI, you write everything in one place. The compiler then:
...
**french:** UniStack est un langage de programmation full-stack unifié qui permet aux développeurs d'écrire des applications entières dans un seul fichier `.uni`. Au lieu de basculer entre Python pour le backend, JavaScript pour le frontend et HTML/CSS pour l'UI, vous écrivez tout au même endroit. Le compilateur fait alors :
...
### Objectif du legacy prototype / legacy prototype Goal

**english:** The legacy prototype (Minimum Viable Product) phase focuses on:
- Merging JS, HTML, CSS, Python, and SQL syntaxes
- Basic transpilation to TypeScript
- Simple routing with HTTP verbs
- No C++/Wasm yet (planned for Advanced line)

**french:** La phase legacy prototype (Minimum Viable Product) se concentre sur :
- Fusionner les syntaxes JS, HTML, CSS, Python et SQL
- Transpilation basique en TypeScript
- Routage simple avec verbes HTTP
- Pas de C++/Wasm encore (prévu pour Advanced line)
...
**Cause / Cause:**
The Python function is defined in your `.uni` file, but the runtime hasn't registered it. Currently the legacy prototype expects manual registration.
...
**Step 2**: In your CLI dev mode, manually register it (temporary workaround for legacy prototype):
...
**TODO for Advanced line**: Auto-register functions from `py-logic:` section.
...
**Cause / Cause:**
La fonction Python est définie dans votre fichier `.uni`, mais le runtime ne l'a pas enregistrée. Actuellement, le legacy prototype s'attend à une enregistrement manuel.
...
**Étape 2**: En mode dev CLI, l'enregistrer manuellement (solution temporaire pour legacy prototype) :
...
**Cause / Cause:**
SQL method is currently a stub in the legacy prototype runtime.
...
**english:** Not yet in the legacy prototype. Currently, Python code is stored as strings in the generated TypeError. Advanced line will include:
- Python subprocess integration
- Py-to-Wasm compilation
- Direct Python execution via runtime

**french:** Pas encore dans le legacy prototype. Actuellement, le code Python est stocké en tant que chaînes. Advanced line inclura :
...
**english:** Planned for Advanced line. Currently not supported. The legacy prototype focuses on JS/HTML/CSS/Python/SQL.

**french:** Prévu pour Advanced line. Non supporté actuellement. Le legacy prototype se concentre sur JS/HTML/CSS/Python/SQL.
...
### Q: Quelles sont les limitations du legacy prototype ? / What are legacy prototype limitations?
...
**Priorities for Advanced line:**

- real Python execution via subprocess or embedded interpreter
- compilation of C++/Wasm code blocks
- SQL database integration with ORM helper
- hot-reload development server
- debugging and profiling support
- IDE/Language Server Protocol plugin (e.g. VSCode)
...
**UniStack Version / Version UniStack:** 0.1.0 (legacy prototype)
