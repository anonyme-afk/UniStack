...
### **For Complete Documentation / Pour la documentation complète**

**english:** **[See GUIDE_COMPLET.md](GUIDE_COMPLET.md)** for an extensive guide with many examples, troubleshooting, and developer information.

**french:** **[Voir GUIDE_COMPLET.md](GUIDE_COMPLET.md)** pour un guide complet avec de nombreux exemples, dépannage et informations développeur.
...
Licence : Ce projet est distribué sous licence Apache 2.0 par The Developers. C'est gratuit et ça le restera.