...
import { UniStackV2Visitor } from "./UniStackV2Visitor";


export class UniStackV2Parser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(UniStackV2Parser._LITERAL_NAMES, UniStackV2Parser._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return UniStackV2Parser.VOCABULARY;
	}
	...
	// @Override
	public get ruleNames(): string[] { return UniStackV2Parser.ruleNames; }

	// @Override
	public get serializedATN(): string { return UniStackV2Parser._serializedATN; }
	...
	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(UniStackV2Parser._ATN, this);
	}
	// @RuleVersion(0)
	public file(): FileContext {
		let _localctx: FileContext = new FileContext(this._ctx, this.state);
		this.enterRule(_localctx, 0, UniStackV2Parser.RULE_file);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 126;
			this.match(UniStackV2Parser.T__0);
			this.state = 127;
			this.match(UniStackV2Parser.T__1);
			this.state = 128;
			this.match(UniStackV2Parser.STRING);
			this.state = 129;
			this.match(UniStackV2Parser.T__2);
			this.state = 130;
			this.match(UniStackV2Parser.VERSION);
			this.state = 131;
			this.match(UniStackV2Parser.LBRACE);
			this.state = 132;
			this.fileBody();
			this.state = 133;
			this.match(UniStackV2Parser.RBRACE);
			this.state = 134;
			this.match(UniStackV2Parser.EOF);
			}
		}
		catch (re) {
	...
	public fileBody(): FileBodyContext {
		...
		this.enterRule(_localctx, 2, UniStackV2Parser.RULE_fileBody);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << UniStackV2Parser.T__3) | (1 << UniStackV2Parser.T__7) | (1 << UniStackV2Parser.T__8) | (1 << UniStackV2Parser.T__10) | (1 << UniStackV2Parser.T__11) | (1 << UniStackV2Parser.T__19) | (1 << UniStackV2Parser.T__20) | (1 << UniStackV2Parser.T__27) | (1 << UniStackV2Parser.T__30))) !== 0)) {
				{
				{
				this.state = 136;
				this.fileSection();
	...
	public fileSection(): FileSectionContext {
		...
		this.enterRule(_localctx, 4, UniStackV2Parser.RULE_fileSection);
		try {
			this.state = 151;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case UniStackV2Parser.T__8:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 142;
				this.importsSection();
	...
	public decoratorSection(): DecoratorSectionContext {
		...
		this.enterRule(_localctx, 6, UniStackV2Parser.RULE_decoratorSection);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 153;
			this.match(UniStackV2Parser.T__3);
			this.state = 154;
			this.match(UniStackV2Parser.T__4);
			this.state = 155;
			this.decoratorList();
			this.state = 156;
			this.match(UniStackV2Parser.SEMI);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public decoratorList(): DecoratorListContext {
		...
		this.enterRule(_localctx, 8, UniStackV2Parser.RULE_decoratorList);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === UniStackV2Parser.COMMA) {
				{
				{
				this.state = 159;
				this.match(UniStackV2Parser.COMMA);
				this.state = 160;
				this.decorator();
				}
				}
	...
	public decorator(): DecoratorContext {
		...
		this.enterRule(_localctx, 10, UniStackV2Parser.RULE_decorator);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 166;
			this.match(UniStackV2Parser.T__5);
			this.state = 167;
			this.match(UniStackV2Parser.IDENT);
			this.state = 169;
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === UniStackV2Parser.LPAREN) {
				{
				this.state = 168;
				this.decoratorArgs();
				}
	...
	public decoratorArgs(): DecoratorArgsContext {
		...
		this.enterRule(_localctx, 12, UniStackV2Parser.RULE_decoratorArgs);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 171;
			this.match(UniStackV2Parser.LPAREN);
			this.state = 172;
			this.decoratorArg();
			this.state = 177;
			this._errHandler.sync(this);
			...
			this.state = 180;
			this.match(UniStackV2Parser.RPAREN);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public decoratorArg(): DecoratorArgContext {
		...
		this.enterRule(_localctx, 14, UniStackV2Parser.RULE_decoratorArg);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === UniStackV2Parser.T__6) {
				{
				this.state = 183;
				this.match(UniStackV2Parser.T__6);
				this.state = 184;
				this.decoratorValue();
				}
			}
	...
	public decoratorValue(): DecoratorValueContext {
		...
		this.enterRule(_localctx, 16, UniStackV2Parser.RULE_decoratorValue);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 187;
			_la = this._input.LA(1);
			if (!(((((_la - 45)) & ~0x1F) === 0 && ((1 << (_la - 45)) & ((1 << (UniStackV2Parser.STRING - 45)) | (1 << (UniStackV2Parser.NUMBER - 45)) | (1 << (UniStackV2Parser.BOOLEAN - 45)))) !== 0))) {
	...
	public styleSection(): StyleSectionContext {
		...
		this.enterRule(_localctx, 18, UniStackV2Parser.RULE_styleSection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 189;
			this.match(UniStackV2Parser.T__7);
			this.state = 190;
			this.match(UniStackV2Parser.T__4);
			this.state = 192;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.STYLE_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public styleLine(): StyleLineContext {
		...
		this.enterRule(_localctx, 20, UniStackV2Parser.RULE_styleLine);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 196;
			this.match(UniStackV2Parser.STYLE_TEXT);
			this.state = 197;
			this.match(UniStackV2Parser.SEMI);
			}
		}
	...
	public importsSection(): ImportsSectionContext {
		...
		this.enterRule(_localctx, 22, UniStackV2Parser.RULE_importsSection);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 199;
			this.match(UniStackV2Parser.T__8);
			this.state = 200;
			this.match(UniStackV2Parser.T__4);
			this.state = 201;
			this.importList();
	...
	public importList(): ImportListContext {
		...
		this.enterRule(_localctx, 24, UniStackV2Parser.RULE_importList);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public importItem(): ImportItemContext {
		...
		this.enterRule(_localctx, 26, UniStackV2Parser.RULE_importItem);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public importAlias(): ImportAliasContext {
		...
		this.enterRule(_localctx, 28, UniStackV2Parser.RULE_importAlias);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 216;
			this.match(UniStackV2Parser.T__9);
			this.state = 217;
			this.match(UniStackV2Parser.IDENT);
			}
		}
	...
	public configSection(): ConfigSectionContext {
		...
		this.enterRule(_localctx, 30, UniStackV2Parser.RULE_configSection);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 219;
			this.match(UniStackV2Parser.T__10);
			this.state = 220;
			this.match(UniStackV2Parser.T__4);
			this.state = 221;
	...
	public configEntryList(): ConfigEntryListContext {
		...
		this.enterRule(_localctx, 32, UniStackV2Parser.RULE_configEntryList);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public configEntry(): ConfigEntryContext {
		...
		this.enterRule(_localctx, 34, UniStackV2Parser.RULE_configEntry);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 232;
	...
	public configValue(): ConfigValueContext {
		...
		this.enterRule(_localctx, 36, UniStackV2Parser.RULE_configValue);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public htmlSection(): HtmlSectionContext {
		...
		this.enterRule(_localctx, 38, UniStackV2Parser.RULE_htmlSection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 238;
			this.match(UniStackV2Parser.T__11);
			this.state = 239;
			this.match(UniStackV2Parser.T__4);
			this.state = 241;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.T__12 || _la === UniStackV2Parser.LBRACE || _la === UniStackV2Parser.HTML_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public htmlBlock(): HtmlBlockContext {
		...
		this.enterRule(_localctx, 40, UniStackV2Parser.RULE_htmlBlock);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public htmlNode(): HtmlNodeContext {
		...
		this.enterRule(_localctx, 42, UniStackV2Parser.RULE_htmlNode);
		try {
			this.state = 255;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case UniStackV2Parser.HTML_TEXT:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 252;
				this.htmlText();
	...
	public htmlText(): HtmlTextContext {
		...
		this.enterRule(_localctx, 44, UniStackV2Parser.RULE_htmlText);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 257;
			this.match(UniStackV2Parser.HTML_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public htmlExpr(): HtmlExprContext {
		...
		this.enterRule(_localctx, 46, UniStackV2Parser.RULE_htmlExpr);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 259;
	...
	public htmlConditional(): HtmlConditionalContext {
		...
		this.enterRule(_localctx, 48, UniStackV2Parser.RULE_htmlConditional);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 263;
			this.match(UniStackV2Parser.T__12);
			this.state = 264;
			this.condition();
			this.state = 265;
			this.match(UniStackV2Parser.RBRACE);
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === UniStackV2Parser.T__13) {
				{
				this.state = 271;
				this.match(UniStackV2Parser.T__13);
				this.state = 273;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				do {
			...
			this.state = 279;
			this.match(UniStackV2Parser.T__14);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public condition(): ConditionContext {
		...
		this.enterRule(_localctx, 50, UniStackV2Parser.RULE_condition);
		try {
			this.state = 294;
			this._errHandler.sync(this);
			...
			case 2:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 283;
				this.match(UniStackV2Parser.T__15);
				this.state = 284;
				this.match(UniStackV2Parser.IDENT);
				}
				break;
			...
			case 3:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 286;
				this.match(UniStackV2Parser.T__16);
				this.state = 287;
				this.match(UniStackV2Parser.IDENT);
				}
				break;
			...
			case 4:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 289;
				this.match(UniStackV2Parser.T__17);
				this.state = 290;
				this.match(UniStackV2Parser.IDENT);
				}
				break;
			...
			case 5:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 292;
				this.match(UniStackV2Parser.T__18);
				this.state = 293;
				this.match(UniStackV2Parser.IDENT);
				}
				break;
	...
	public cssSection(): CssSectionContext {
		...
		this.enterRule(_localctx, 52, UniStackV2Parser.RULE_cssSection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 296;
			this.match(UniStackV2Parser.T__19);
			this.state = 297;
			this.match(UniStackV2Parser.T__4);
			this.state = 299;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.CSS_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public cssChunk(): CssChunkContext {
		...
		this.enterRule(_localctx, 54, UniStackV2Parser.RULE_cssChunk);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 303;
			this.match(UniStackV2Parser.CSS_TEXT);
			this.state = 304;
			this.match(UniStackV2Parser.SEMI);
			}
		}
	...
	public pySection(): PySectionContext {
		...
		this.enterRule(_localctx, 56, UniStackV2Parser.RULE_pySection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 306;
			this.match(UniStackV2Parser.T__20);
			this.state = 307;
			this.match(UniStackV2Parser.T__4);
			this.state = 309;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.T__5 || _la === UniStackV2Parser.T__21);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public pyFunction(): PyFunctionContext {
		...
		this.enterRule(_localctx, 58, UniStackV2Parser.RULE_pyFunction);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === UniStackV2Parser.T__5) {
				{
				{
				this.state = 313;
				this.pyDecorator();
			...
			this.state = 319;
			this.match(UniStackV2Parser.T__21);
			this.state = 320;
			this.match(UniStackV2Parser.IDENT);
			this.state = 322;
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === UniStackV2Parser.T__17) {
				{
				this.state = 321;
				this.genericParams();
				}
	...
	public pyDecorator(): PyDecoratorContext {
		...
		this.enterRule(_localctx, 60, UniStackV2Parser.RULE_pyDecorator);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 334;
	...
	public genericParams(): GenericParamsContext {
		...
		this.enterRule(_localctx, 62, UniStackV2Parser.RULE_genericParams);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public pyParams(): PyParamsContext {
		...
		this.enterRule(_localctx, 64, UniStackV2Parser.RULE_pyParams);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public pyParam(): PyParamContext {
		...
		this.enterRule(_localctx, 66, UniStackV2Parser.RULE_pyParam);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public typeAnnotation(): TypeAnnotationContext {
		...
		this.enterRule(_localctx, 68, UniStackV2Parser.RULE_typeAnnotation);
		try {
			this.state = 373;
			this._errHandler.sync(this);
			...
			case 2:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 363;
				this.match(UniStackV2Parser.T__22);
				this.state = 364;
				this.match(UniStackV2Parser.IDENT);
				this.state = 365;
				this.match(UniStackV2Parser.T__23);
				}
				break;
			...
			case 3:
				...
				this.match(UniStackV2Parser.IDENT);
				this.state = 367;
				this.match(UniStackV2Parser.T__24);
				this.state = 368;
				this.match(UniStackV2Parser.IDENT);
				}
				break;
			...
			case 4:
				...
				{
				this.state = 369;
				this.match(UniStackV2Parser.T__25);
				this.state = 370;
				this.match(UniStackV2Parser.T__22);
				this.state = 371;
				this.match(UniStackV2Parser.IDENT);
	...
	public returnType(): ReturnTypeContext {
		...
		this.enterRule(_localctx, 70, UniStackV2Parser.RULE_returnType);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 375;
			this.match(UniStackV2Parser.T__26);
			this.state = 376;
			this.typeAnnotation();
			}
		}
	...
	public pyBody(): PyBodyContext {
		...
		this.enterRule(_localctx, 72, UniStackV2Parser.RULE_pyBody);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				{
				this.state = 378;
				this.match(UniStackV2Parser.PY_TEXT);
				}
				}
				this.state = 381;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.PY_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public jsSection(): JsSectionContext {
		...
		this.enterRule(_localctx, 74, UniStackV2Parser.RULE_jsSection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 383;
			this.match(UniStackV2Parser.T__27);
			this.state = 384;
			this.match(UniStackV2Parser.T__4);
			this.state = 386;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << UniStackV2Parser.T__5) | (1 << UniStackV2Parser.T__28) | (1 << UniStackV2Parser.T__29))) !== 0));
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public jsFunction(): JsFunctionContext {
		...
		this.enterRule(_localctx, 76, UniStackV2Parser.RULE_jsFunction);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this.state = 399;
			this.match(UniStackV2Parser.T__28);
			this.state = 400;
			this.match(UniStackV2Parser.IDENT);
			this.state = 402;
			this._errHandler.sync(this);
	...
	public jsDecorator(): JsDecoratorContext {
		...
		this.enterRule(_localctx, 78, UniStackV2Parser.RULE_jsDecorator);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 414;
	...
	public asyncKeyword(): AsyncKeywordContext {
		...
		this.enterRule(_localctx, 80, UniStackV2Parser.RULE_asyncKeyword);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 417;
			this.match(UniStackV2Parser.T__29);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public jsParams(): JsParamsContext {
		...
		this.enterRule(_localctx, 82, UniStackV2Parser.RULE_jsParams);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public jsParam(): JsParamContext {
		...
		this.enterRule(_localctx, 84, UniStackV2Parser.RULE_jsParam);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public jsBody(): JsBodyContext {
		...
		this.enterRule(_localctx, 86, UniStackV2Parser.RULE_jsBody);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				{
				this.state = 432;
				this.match(UniStackV2Parser.JS_TEXT);
				}
				}
				this.state = 435;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.JS_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public routesSection(): RoutesSectionContext {
		...
		this.enterRule(_localctx, 88, UniStackV2Parser.RULE_routesSection);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 437;
			this.match(UniStackV2Parser.T__30);
			this.state = 438;
			this.match(UniStackV2Parser.T__4);
			this.state = 440;
			this._errHandler.sync(this);
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (UniStackV2Parser.T__31 - 32)) | (1 << (UniStackV2Parser.T__32 - 32)) | (1 << (UniStackV2Parser.T__33 - 32)) | (1 << (UniStackV2Parser.T__34 - 32)) | (1 << (UniStackV2Parser.T__35 - 32)) | (1 << (UniStackV2Parser.T__36 - 32)) | (1 << (UniStackV2Parser.T__37 - 32)))) !== 0));
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public route(): RouteContext {
		...
		this.enterRule(_localctx, 90, UniStackV2Parser.RULE_route);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public httpMethod(): HttpMethodContext {
		...
		this.enterRule(_localctx, 92, UniStackV2Parser.RULE_httpMethod);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 450;
			_la = this._input.LA(1);
			if (!(((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (UniStackV2Parser.T__31 - 32)) | (1 << (UniStackV2Parser.T__32 - 32)) | (1 << (UniStackV2Parser.T__33 - 32)) | (1 << (UniStackV2Parser.T__34 - 32)) | (1 << (UniStackV2Parser.T__35 - 32)) | (1 << (UniStackV2Parser.T__36 - 32)) | (1 << (UniStackV2Parser.T__37 - 32)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public handler(): HandlerContext {
		...
		this.enterRule(_localctx, 94, UniStackV2Parser.RULE_handler);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 452;
	...
	public routeBody(): RouteBodyContext {
		...
		this.enterRule(_localctx, 96, UniStackV2Parser.RULE_routeBody);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (UniStackV2Parser.T__38 - 39)) | (1 << (UniStackV2Parser.T__39 - 39)) | (1 << (UniStackV2Parser.T__41 - 39)) | (1 << (UniStackV2Parser.IDENT - 39)))) !== 0)) {
				{
				{
				this.state = 456;
				this.routeStatement();
	...
	public routeStatement(): RouteStatementContext {
		...
		this.enterRule(_localctx, 98, UniStackV2Parser.RULE_routeStatement);
		try {
			this.state = 466;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case UniStackV2Parser.IDENT:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 462;
				this.functionCall();
	...
	public errorHandler(): ErrorHandlerContext {
		...
		this.enterRule(_localctx, 100, UniStackV2Parser.RULE_errorHandler);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 468;
			this.match(UniStackV2Parser.T__38);
			this.state = 469;
			this.match(UniStackV2Parser.LBRACE);
			this.state = 470;
			this.errorBody();
	...
	public errorBody(): ErrorBodyContext {
		...
		this.enterRule(_localctx, 102, UniStackV2Parser.RULE_errorBody);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				{
				this.state = 473;
				this.match(UniStackV2Parser.ERROR_TEXT);
				}
				}
				this.state = 476;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === UniStackV2Parser.ERROR_TEXT);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public functionCall(): FunctionCallContext {
		...
		this.enterRule(_localctx, 104, UniStackV2Parser.RULE_functionCall);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 45)) & ~0x1F) === 0 && ((1 << (_la - 45)) & ((1 << (UniStackV2Parser.STRING - 45)) | (1 << (UniStackV2Parser.NUMBER - 45)) | (1 << (UniStackV2Parser.IDENT - 45)))) !== 0)) {
				{
				this.state = 480;
				this.functionArgs();
				}
	...
	public functionArgs(): FunctionArgsContext {
		...
		this.enterRule(_localctx, 106, UniStackV2Parser.RULE_functionArgs);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public functionArg(): FunctionArgContext {
		...
		this.enterRule(_localctx, 108, UniStackV2Parser.RULE_functionArg);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public datasetOp(): DatasetOpContext {
		...
		this.enterRule(_localctx, 110, UniStackV2Parser.RULE_datasetOp);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 495;
			this.match(UniStackV2Parser.T__39);
			this.state = 496;
			this.match(UniStackV2Parser.T__40);
			this.state = 497;
			this.match(UniStackV2Parser.IDENT);
			this.state = 498;
			this.match(UniStackV2Parser.LPAREN);
	...
	public jsonResponse(): JsonResponseContext {
		...
		this.enterRule(_localctx, 112, UniStackV2Parser.RULE_jsonResponse);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 504;
			this.match(UniStackV2Parser.T__41);
			this.state = 505;
			this.match(UniStackV2Parser.LBRACE);
			this.state = 507;
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === UniStackV2Parser.STRING) {
				{
				this.state = 506;
				this.jsonPairs();
				}
	...
	public jsonPairs(): JsonPairsContext {
		...
		this.enterRule(_localctx, 114, UniStackV2Parser.RULE_jsonPairs);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public jsonPair(): JsonPairContext {
		...
		this.enterRule(_localctx, 116, UniStackV2Parser.RULE_jsonPair);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 519;
	...
	public jsonValue(): JsonValueContext {
		...
		this.enterRule(_localctx, 118, UniStackV2Parser.RULE_jsonValue);
		try {
			this.state = 529;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case UniStackV2Parser.STRING:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 523;
				this.match(UniStackV2Parser.STRING);
				...
				break;
			case UniStackV2Parser.NUMBER:
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 524;
				this.match(UniStackV2Parser.NUMBER);
				}
				break;
			case UniStackV2Parser.BOOLEAN:
				this.enterOuterAlt(_localctx, 3);
				{
				this.state = 525;
				this.match(UniStackV2Parser.BOOLEAN);
				}
				break;
			case UniStackV2Parser.NULL:
				this.enterOuterAlt(_localctx, 4);
				{
				this.state = 526;
				this.match(UniStackV2Parser.NULL);
				}
				break;
			case UniStackV2Parser.T__22:
				this.enterOuterAlt(_localctx, 5);
				{
				this.state = 527;
				this.jsonArray();
	...
	public jsonArray(): JsonArrayContext {
		...
		this.enterRule(_localctx, 120, UniStackV2Parser.RULE_jsonArray);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 23)) & ~0x1F) === 0 && ((1 << (_la - 23)) & ((1 << (UniStackV2Parser.T__22 - 23)) | (1 << (UniStackV2Parser.NULL - 23)) | (1 << (UniStackV2Parser.STRING - 23)) | (1 << (UniStackV2Parser.NUMBER - 23)) | (1 << (UniStackV2Parser.BOOLEAN - 23)) | (1 << (UniStackV2Parser.LBRACE - 23)))) !== 0)) {
				{
				this.state = 532;
				this.jsonValue();
				this.state = 537;
	...
	public jsonObject(): JsonObjectContext {
		...
		this.enterRule(_localctx, 122, UniStackV2Parser.RULE_jsonObject);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public langRef(): LangRefContext {
		...
		this.enterRule(_localctx, 124, UniStackV2Parser.RULE_langRef);
		try {
			this.state = 564;
			this._errHandler.sync(this);
			...
			case 2:
				...
				{
				this.state = 560;
				this.match(UniStackV2Parser.T__42);
				this.state = 561;
				this.match(UniStackV2Parser.T__4);
				this.state = 562;
				this.match(UniStackV2Parser.IDENT);
	...
	public static get _ATN(): ATN {
		if (!UniStackV2Parser.__ATN) {
			UniStackV2Parser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(UniStackV2Parser._serializedATN));
		}

		return UniStackV2Parser.__ATN;
	}

}

export class FileContext extends ParserRuleContext {
	public STRING(): TerminalNode { return this.getToken(UniStackV2Parser.STRING, 0); }
	public VERSION(): TerminalNode { return this.getToken(UniStackV2Parser.VERSION, 0); }
	public LBRACE(): TerminalNode { return this.getToken(UniStackV2Parser.LBRACE, 0); }
	public fileBody(): FileBodyContext {
		return this.getRuleContext(0, FileBodyContext);
	}
	public RBRACE(): TerminalNode { return this.getToken(UniStackV2Parser.RBRACE, 0); }
	public EOF(): TerminalNode { return this.getToken(UniStackV2Parser.EOF, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_file; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class FileBodyContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_fileBody; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class FileSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_fileSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorSectionContext extends ParserRuleContext {
	...
	public SEMI(): TerminalNode { return this.getToken(UniStackV2Parser.SEMI, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decoratorSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorListContext extends ParserRuleContext {
	...
	public COMMA(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(UniStackV2Parser.COMMA);
		} else {
			return this.getToken(UniStackV2Parser.COMMA, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decoratorList; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorContext extends ParserRuleContext {
	public IDENT(): TerminalNode { return this.getToken(UniStackV2Parser.IDENT, 0); }
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decorator; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorArgsContext extends ParserRuleContext {
	public LPAREN(): TerminalNode { return this.getToken(UniStackV2Parser.LPAREN, 0); }
	public decoratorArg(): DecoratorArgContext[];
	...
	public RPAREN(): TerminalNode { return this.getToken(UniStackV2Parser.RPAREN, 0); }
	public COMMA(): TerminalNode[];
	public COMMA(i: number): TerminalNode;
	public COMMA(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decoratorArgs; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorArgContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decoratorArg; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DecoratorValueContext extends ParserRuleContext {
	public STRING(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.STRING, 0); }
	public NUMBER(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.NUMBER, 0); }
	public BOOLEAN(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.BOOLEAN, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_decoratorValue; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class StyleSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_styleSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class StyleLineContext extends ParserRuleContext {
	public STYLE_TEXT(): TerminalNode { return this.getToken(UniStackV2Parser.STYLE_TEXT, 0); }
	public SEMI(): TerminalNode { return this.getToken(UniStackV2Parser.SEMI, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_styleLine; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ImportsSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_importsSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ImportListContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_importList; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ImportItemContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_importItem; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ImportAliasContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_importAlias; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ConfigSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_configSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ConfigEntryListContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_configEntryList; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ConfigEntryContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_configEntry; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ConfigValueContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_configValue; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlBlockContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlBlock; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlNodeContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlNode; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlTextContext extends ParserRuleContext {
	public HTML_TEXT(): TerminalNode { return this.getToken(UniStackV2Parser.HTML_TEXT, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlText; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlExprContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlExpr; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HtmlConditionalContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_htmlConditional; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ConditionContext extends ParserRuleContext {
	...
	public IDENT(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(UniStackV2Parser.IDENT);
		} else {
			return this.getToken(UniStackV2Parser.IDENT, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_condition; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class CssSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_cssSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class CssChunkContext extends ParserRuleContext {
	public CSS_TEXT(): TerminalNode { return this.getToken(UniStackV2Parser.CSS_TEXT, 0); }
	public SEMI(): TerminalNode { return this.getToken(UniStackV2Parser.SEMI, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_cssChunk; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PySectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pySection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PyFunctionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pyFunction; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PyDecoratorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pyDecorator; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class GenericParamsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_genericParams; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PyParamsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pyParams; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PyParamContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pyParam; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class TypeAnnotationContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_typeAnnotation; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ReturnTypeContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_returnType; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class PyBodyContext extends ParserRuleContext {
	...
	public PY_TEXT(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(UniStackV2Parser.PY_TEXT);
		} else {
			return this.getToken(UniStackV2Parser.PY_TEXT, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_pyBody; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsFunctionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsFunction; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsDecoratorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsDecorator; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class AsyncKeywordContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_asyncKeyword; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsParamsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsParams; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsParamContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsParam; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsBodyContext extends ParserRuleContext {
	...
	public JS_TEXT(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(UniStackV2Parser.JS_TEXT);
		} else {
			return this.getToken(UniStackV2Parser.JS_TEXT, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsBody; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class RoutesSectionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_routesSection; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class RouteContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_route; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HttpMethodContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_httpMethod; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class HandlerContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_handler; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class RouteBodyContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_routeBody; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class RouteStatementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_routeStatement; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ErrorHandlerContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_errorHandler; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class ErrorBodyContext extends ParserRuleContext {
	...
	public ERROR_TEXT(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(UniStackV2Parser.ERROR_TEXT);
		} else {
			return this.getToken(UniStackV2Parser.ERROR_TEXT, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_errorBody; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class FunctionCallContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_functionCall; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class FunctionArgsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_functionArgs; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class FunctionArgContext extends ParserRuleContext {
	public IDENT(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.IDENT, 0); }
	public STRING(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.STRING, 0); }
	public NUMBER(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.NUMBER, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_functionArg; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class DatasetOpContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_datasetOp; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonResponseContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonResponse; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonPairsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonPairs; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonPairContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonPair; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonValueContext extends ParserRuleContext {
	...
	public NUMBER(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.NUMBER, 0); }
	public BOOLEAN(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.BOOLEAN, 0); }
	public NULL(): TerminalNode | undefined { return this.tryGetToken(UniStackV2Parser.NULL, 0); }
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonValue; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonArrayContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonArray; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class JsonObjectContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_jsonObject; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
...
export class LangRefContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return UniStackV2Parser.RULE_langRef; }
	// @Override
	public accept<Result>(visitor: UniStackV2Visitor<Result>): Result {
